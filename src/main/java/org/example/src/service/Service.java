...
import org.example.src.curent.Curent;
...
public class Service {
    ...
    public Student addStudent(Student student) {
        ...
        Student value = studentFileRepository.save(student);
        return value;
    }
     ...
     */
    public double addNota(Nota nota, String feedback) throws IOException {
        ...
        String filename = "src/main/java/org/example/fisiere/" + student.getNume() + ".txt";
        ...
        outputStream.write(("\nTema: " + tema.getID()).getBytes(StandardCharsets.UTF_8));
        outputStream.write(("\nNota: " + nota.getNota()).getBytes(StandardCharsets.UTF_8));
        outputStream.write(("\nPredata in saptamana: " + predare).getBytes(StandardCharsets.UTF_8));
        outputStream.write(("\nDeadline: " + tema.getDeadline()).getBytes(StandardCharsets.UTF_8));
        outputStream.write(("\nFeedback: " + feedback).getBytes(StandardCharsets.UTF_8));
